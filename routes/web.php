...
use App\Http\Controllers\Student\StudentWeatherController;
use App\Http\Controllers\Teacher\TeacherWeatherController;
...
Route::middleware(['auth', AdminMiddleware::class])->prefix('admin')->group(function () {
  ...
  // Weather App (Admin Access)
    Route::get('/weather', [WeatherController::class, 'index'])->name('admin.weather.index');
    Route::post('/weather', [WeatherController::class, 'getWeather'])->name('admin.weather.get');

    // Frontend Website
    Route::get('/website/institute', [FrontendController::class, 'index'])->name('frontend.institute');
...
// Weather App (teacher Access)
    Route::get('/weather', [TeacherWeatherController::class, 'index'])->name('teachers.weather.index');
    Route::post('/weather', [TeacherWeatherController::class, 'getWeather'])->name('teachers.weather.get');
...
// Weather App (student Access)
    ...
    // Frontend Website
    Route::get('/website/institute', [FrontendController::class, 'index'])->name('frontend.institute');      Route::get('/', [FrontendController::class, 'login']);
    // profile
